...
function SingleProduct() {
    ...
    <div class="toast m-5 alert alert-success shadow " id="myToast"  data-delay="5000">
    ...
    <div class="toast-body">
        <strong class="" >Your order has aded to the <a href="cart.php">CART</a> Successfully! </strong>
    </div>
    </div>
			...
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<h2>Rs.3200</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> :Category 1</a></li>
