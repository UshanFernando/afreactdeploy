...
export class ResetPassword extends Component {
        ...
        async profile() {
            if (this.state.categoryName.trim() !== 0) {
              try {
                ...
                await fetch("http://localhost:5000/reset/reset", requestOptions);
                this.loadCategories();
                this.setState({
                  categoryName: "",
                });
    ...
    render() {
        ...
        <section class="login_box_area section-margin">
          <div class="container">
            <div className="card bg-light mt-3" style={{width:"600px", marginLeft:"300px"}}>
              <form className="form-signin" action="/register/register" method="POST">
              <button className="btn btn-md btn-success"   type="submit" style={{width:"180px",marginLeft:"225px"}}><a href="/Home">Go to home</a></button>
                    <h1 className="h3 mb-3 font-weight-normal" >Account Details</h1>
                    <div className="input-group mb-2" style={{width:"500px", marginLeft:"50px" }}>
                    <div className="input-group-prepend">
                        <div className="input-group-text">First Name</div>
                    ...
                    <button className="btn btn-md btn-warning "  type="submit" style={{width:"180px",marginLeft:"225px"}}>Update Details</button></form>
                    
                    <br></br><label htmlFor="sel1">Input your email here to delete the account :</label>
                     <input type="email" id="inputEmail" name="dCusEmail" onChange={this.setDeleteEmail} className="form-control" placeholder="Email address" required autoFocus></input>
                    <br></br><button className="btn btn-md btn-danger " onClick={this.deleteCustomer} type="submit" style={{width:"180px", marginLeft:"225px"}}>Delete Account</button>
